...
product_kind_of_product_type_id|varchar(72)|+|product_type|Идентификатор типов продукта
...
product_type_product_group_id|varchar(72)|+|product_group|Идентификатор группы продукта
